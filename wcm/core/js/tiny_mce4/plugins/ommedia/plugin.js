     ...
     init: function(ed, url) {
         ...
         ed.addCommand('mceOMMedia', function() {
             ed.windowManager.open({
                 ...
                 width: 650 + parseInt(ed.getLang('ommedia.delta_width', 0)),
         ...
         ed.addButton('ommedia', {
             ...
             onPostRender: function() {
		         ...
		         ed.on('NodeChange', function(e) {
		            ctrl.active(e.element.nodeName == 'IMG' && isMediaElm(e.element));
		         });
             }
         });
         ...
         ed.on('Init', function() {
             ...
             if (ed.theme && ed.theme.onResolveName) {
                 ed.theme.on("ResolveName", function(th, o) {
                     if (o.name == 'img') {
         ...
         ed.on('PreProcess', function(o) {
 		  ...
 		  ed.addMenuItem('ommedia', {
		        icon: 'image',
		        text: 'Media property',
		        shortcut: 'Ctrl+J',
		        onclick: function() {
		        	ed.execCommand('mceOMMedia');
		        },
		        context: 'insert',
